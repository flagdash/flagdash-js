...
|-----|---------|---------|------|
| **JavaScript/TypeScript** | [`@flagdashio/sdk`](packages/sdk/) | `npm install @flagdashio/sdk` | [Docs](https://flagdash.com/docs#sdk-javascript) |
| **React** | [`@flagdashio/react`](packages/react/) | `npm install @flagdashio/react` | [Docs](https://flagdash.com/docs#sdk-react) |
| **Node.js** | [`@flagdashio/node`](packages/node/) | `npm install @flagdashio/node` | [Docs](https://flagdash.com/docs#sdk-node) |
